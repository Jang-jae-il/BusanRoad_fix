...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<a href ="search"><button>주차가능+엘리베이터가능</button></a>
			<a href ="search2"><button>주차가능+엘리베이터가능+점자가능</button></a>
			...
			<div class="col-md-9 col-lg-8 ">
				...
				<%
					...
					%>
						<button class="b1" pageNo="<%=p%>" style="background: #0067A3; color: white;"><%=p%></button>
					<%
						}
					%>
			</div>
